...
integer i, pointsNum, freqNum
 ...
 !   eps22 = 3.27d-1
    ...
    open(3, file="C:\Users\tiama\OneDrive\–абочий стол\IMMI\Nedospasov\pz4\pz4\DispSurfer2\S2.txt", FORM='FORMATTED');
    
    open(4, file="C:\Users\tiama\OneDrive\–абочий стол\IMMI\Nedospasov\pz4\pz4\DispSurfer2\A0.txt", FORM='FORMATTED');
    open(5, file="C:\Users\tiama\OneDrive\–абочий стол\IMMI\Nedospasov\pz4\pz4\DispSurfer2\A1.txt", FORM='FORMATTED');
    open(6, file="C:\Users\tiama\OneDrive\–абочий стол\IMMI\Nedospasov\pz4\pz4\DispSurfer2\A2.txt", FORM='FORMATTED');
